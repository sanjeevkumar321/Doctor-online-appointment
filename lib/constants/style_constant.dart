...
var doctorsSubtitle = GoogleFonts.inter(
    fontWeight: FontWeight.w400, fontSize: 13, color: mSubtitleColor);

var sTitleStyle = GoogleFonts.inter(
    fontWeight: FontWeight.w800, color: mTitleColor, fontSize: 10);
...
var mMoreDiscountStyle = GoogleFonts.inter(
    fontSize: 12, fontWeight: FontWeight.w700, color: headingColor);
...
var mTravlogPlaceStyle = GoogleFonts.inter(
    fontSize: 10, fontWeight: FontWeight.w500, color: headingColor);